  ...
  const onHandleDocCreated = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_BASE_URL}/api/user/create-sheet`,
        docData
      )
  ...
  return (
    <>
      <Banner
        ...
        text="Fill your information correctly and get your sheet"
      />
          ...
          <div className="md:w-2/3 w-full space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col p-4 border-2 border-gray-200 rounded-lg">
                ...
                />
                {errors.Post && (
                  <p className="text-red-500 text-xs">{errors.Post}</p>
                )}
              </div>
            </div>
