      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        ...
        >
          <div className="bg-white rounded-lg shadow-md p-6 border border-orange-300">
            <h2 className="md:text-xl text-lg font-bold mb-4">
              Fast & Hassle-Free Processes
            </h2>
            <p className="text-gray-700 md:text-base text-xs">
              Save time and effort with our streamlined documentation services,
              designed to eliminate long queues and paperwork.
            </p>
          </div>
          <div className="bg-orange-100 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700 md:text-base text-xs">
              We prioritize your privacy with state-of-the-art security to
              ensure your documents are safe and accessible.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-orange-100 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-700 md:text-base text-xs">
              We bring cutting-edge technology to modernize the way documents
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border border-orange-300">
            ...
            <p className="text-gray-700 md:text-base text-xs">
              Enjoy a seamless experience with our intuitive platform designed
